...
$red_all_parti = mysqli_fetch_array(mysqli_query($con, "SELECT total_users FROM start_game WHERE pod_name = 'RED' LIMIT 1"));
$red_today_parti = mysqli_fetch_array(mysqli_query($con, "SELECT total_users FROM start_game WHERE pod_name = 'RED' AND game_date = '".$start_date."' LIMIT 1"));
...
$blue_all_parti = mysqli_fetch_array(mysqli_query($con, "SELECT total_users FROM start_game WHERE pod_name = 'BLUE' LIMIT 1"));
$blue_today_parti = mysqli_fetch_array(mysqli_query($con, "SELECT total_users FROM start_game WHERE pod_name = 'BLUE' AND game_date = '".$start_date."'  LIMIT 1"));
