...
<html lang="en">
    ...
    <?php
        ...
        $red_ball_top = mysqli_fetch_array(mysqli_query($con, "SELECT *, CAST(final_score AS UNSIGNED) AS score FROM user_submissions WHERE created_at < '".date('Y-m-d 00:00:00')."' AND pod_name = 'RED' ORDER BY score DESC, last_click_time ASC")); 
        $blue_ball_top = mysqli_fetch_array(mysqli_query($con, "SELECT *, CAST(final_score AS UNSIGNED) AS score FROM user_submissions WHERE created_at < '".date('Y-m-d 00:00:00')."' AND pod_name = 'RED' ORDER BY score DESC, last_click_time ASC")); 
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            ...
                            <h6 class="some_sec">
                                ...
                                <?php
                                    if(!empty($red_ball_top)) {
                                    
                                    ?>
                                Topper of day : <?=$red_ball_top['full_name']?>
                                <?php
                                    }
                        ...
                        <div class="col-md-6">
                            ...
                            <h6 class="some_second">
                                <?php
                                    if(!empty($blue_ball_top)) {
                                    
                                    ?>
                                Topper of day : <?=$blue_ball_top['full_name']?>
                                <?php
                                    }
