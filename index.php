        ...
        <div id="portfolio" style="background: url('assets/img/Background-1.png') top;">
            <div class="container p-0">
                <div class="row">
                    ...
                    <div class="col-md-12 text-center">
                    	<p class="nw-pp">Spot Prizes will be available for our #BlazePodTeam Red and #BlazePodTeamBlue Players of the Day, check our leaderboard and social media for updates. Plus, if you're in the Top Ten on either Team Red or Team Blue at the end of November, then you'll definitely be winning prizes, vouchers and most importantly, bragging rights over all your friends and family!</p>
                    </div>
